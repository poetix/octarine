...
import com.codepoetics.octarine.json.ReflectiveJsonRecordSerialiser;
...
public class SerialisationTest {
    ...
    writes_list_of_maps_of_lists_of_ints_as_json() {
        ...
        String json = asArray(asMap(asArray(asInteger))).toString(asList(map1, map2));
    ...
    reflective_serialisation_works_too() throws JsonProcessingException {
        ...
        ObjectMapper mapper = ReflectiveJsonRecordSerialiser.mapperWith(new ColorJsonSerializer());
